    ...
    return (
        <>
            <section className='Ian_aboutFirst'>
                <div className='Ian_firstText'> {/* 整體內容外框 */}
                    <div className='Ian_firstMain'>
                        ...
                        <div className='Ian_boutBox'>
                            <div className='Ian_bout'>
                                <img src="images/bout.png" alt="" />
                            </div>
                        </div>
                        <div className='Ian_aboutText1Box'>
            ...
            <section className='Ian_aboutThird'>
                ...
                <div className='Ian_storyDecorateBox'>
                    <div className='Ian_storyDecorateBox1'></div>
                    <div className='Ian_storyTitle'><h2>我們的故事</h2></div>
                    <div className='Ian_storyDecorateBox2'></div>
                </div>
