    ...
    return (
        <>
            ...
            <main className="barInnerPage">
                <div className='barInnerPageContainer'>
                    {/* Hero 區 */}
                    <section id="barInnerHero" className="barInnerHeroContainer">

                        {/* 左側：hero酒吧文案 */}
                        <div className="barInnerCardLeft">
                            <h2>潮飲空間</h2>

                            {/* 連絡資訊*/}
                            <address className="barInnerContact" /* SCSS 再把預設斜體改回正常 */>
                                <p>地址：新北市新北一路二段15樓</p>
                                <p>電話：0949-494-949</p>
                            ...
                            {/* 左側hero酒吧文案*/}
                            <div className="barInnerDescription">
                        ...
                        {/* 右側：hero酒吧圖片 */}
                        <div className="barInnerCardRight">
                            <figure className="barInnerHeroPhoto">
                                <img className="barInnerHeroImg" src={heroImg} alt="潮飲空間圖片" />
                                <img className="barInnerArrowImg1" src={arrowImg1} alt="裝飾箭頭1" />
                            </figure>
                        </div>
                    ...
                    {/* 按鈕容器 */}
                    <div className='barInnerBtnContainer'>
                        <Link to="/Bar" className="barInnerBtnToListPage">
                            回到酒吧列表
                        </Link>
                    </div>

                    {/* 純粹只是背景板的一個黑色區塊 */}
                    <div className="barInnerBlackBlock">
                    </div>
